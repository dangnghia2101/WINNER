...
const images = {
    bg_stared: require("./bg_started.png").default,
    Ellipse1: require("./Ellipse 1.png").default,
    Ellipse6: require("./Ellipse 6.png").default,
    DangTruong: require("./founder/DangTruong.jpeg").default,
    MauPhi: require("./founder/MauPhi.jpeg").default,
